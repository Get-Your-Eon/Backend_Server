...
def upgrade() -> None:
    ...
    op.alter_column('api_logs', 'id',
               ...
               comment=None,
               existing_comment='API 호출 로그 고유 ID',
    ...
    op.alter_column('chargers', 'status_code',
               ...
               existing_nullable=True)
    op.drop_constraint(op.f('uq_station_charger_code'), 'chargers', type_='unique')
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_constraint('_station_charger_uc', 'chargers', type_='unique')
